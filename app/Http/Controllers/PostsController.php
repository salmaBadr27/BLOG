...
class PostsController extends Controller
{
 ...
 /**
    ...
    {
        $this->middleware('auth',['except'=>['index','show']]); // authenticate to show only posts and single post without allow user to go to create or edit post
    }
    ...
    {   
        ...
        $posts = Post::all()->orderBy('created_at','desc')->paginate(10);  //another way to 
    ...
    {
        $post = Post::find($id); // show post by passed id     
    ...
    {
        $post = Post::find($id); // edit post by passed id     
